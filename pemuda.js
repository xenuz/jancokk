...
└─────────────────⬣
${uwu}`
pemuda.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/aOII8FmqQvQ`}}})
break
case 'command':
 listMsg = {
 buttonText: 'LIST MENU',
 footerText: '*_© KyuraBotz_*',
...
case 'culik':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
if (args.length < 1) return reply('_*please insert group id!!*_')
let pantek = []
